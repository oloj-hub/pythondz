...
def klyuv():
    brushColor('yellow')
    polygon([[627, 677], [676, 671], [676, 671], [689, 679], [689, 679], [628, 683], [628, 683], [690, 680], [690, 680],
             [674, 697], [674, 697], [625, 688], [627, 677]])
...
def nogazad():
    ...
    brushColor('white')
    polygon([[450, 797], [488, 809], [489, 809], [512, 826], [511, 826], [504, 835], [504, 835], [450, 818], [450, 818],
             [438, 803], [450, 797]])
    brushColor('yellow')
    polygon([[511, 824], [548, 817], [546, 816], [523, 827], [523, 827], [543, 832], [543, 832], [517, 834], [517, 834],
             [532, 843], [530, 843], [511, 838], [511, 838], [508, 844], [508, 844], [503, 833], [511, 824]])
...
def nogapered():
    ...
    brushColor('white')
    polygon([[410, 806], [457, 829], [455, 829], [464, 846], [464, 846], [456, 854], [455, 854], [406, 823], [406, 822],
             [397, 803], [410, 806]])
    brushColor('yellow')
    polygon([[461, 847], [503, 855], [500, 854], [467, 855], [468, 856], [493, 868], [491, 868], [466, 862], [466, 863],
             [472, 880], [473, 879], [454, 854], [456, 858], [454, 865], [454, 865], [449, 850], [461, 847]])
...
def update():
    ...
    if (i == 1):
        ...
        deleteObject(krilo1)
        krilo1 = polygon(
            [[451, 683], [442, 593], [382, 572], [314, 528], [338, 590], [383, 622], [390, 672], [451, 683]])
        deleteObject(krilo2)
        krilo2 = polygon(
            [[442, 687], [406, 615], [334, 602], [293, 579], [312, 625], [369, 639], [376, 683], [442, 687]])
    i = -i
